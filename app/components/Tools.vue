<template>
  <section id="tools" style="background-color: var(--color-bg);">
    ...
    <div class="max-w-[1100px] mx-auto px-6 md:px-10 py-16 md:py-24 overflow-visible">
      <!-- Container for the curved stacked tools -->
      <div class="flex flex-row justify-center items-center -space-x-4 md:-space-x-8 py-10 px-4 overflow-visible min-h-[160px] md:min-h-[220px]">
        ...
        >
          <!-- GitHub uses inline SVG since the remote one doesn't load -->
